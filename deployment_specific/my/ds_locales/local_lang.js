  ...
  constructor() {
    this.languages = {
      ...
      en: {
        ...
        "report_content": {
          ...
          "twitter": {
            ...
            "steps": [
              ...
              "You can see your report on the map via the link provided. Check RiskMap.my for up-to-date flood information."
            ]
          },
          "telegram": {
          ...
          "otherapps": {
            ...
            "steps": [
              ...
              "Your report is now on the map. Check RiskMap.my for up-to-date flood information."
            ],
        ...
        "info_content": {
          "intro": "RiskMap.my harnesses the power of social media to gather, sort, and display information about flooding in real time.",
          "p1": "RiskMap.my is a project initiated by the Urban Risk Lab at MIT as a free, transparent platform for emergency response and disaster management in megacities in South and Southeast Asia.",
          ...
          "p3": "RiskMap.my gathers, sorts, and visualizes data using specially developed CogniCity Open Source Software - an enterprise-level platform for emergency response and disaster management - to transforms the noise of social and digital media into critical information for residents, communities, and government agencies.",
          "partners": {
        ...
        "report_content": {
          ...
          "twitter": {
            ...
            "steps": [
              ...
              "Anda dapat melihat laporan Anda di peta lewat link balasan. Cek RiskMap.my untuk info banjir terkini."
            ]
          },
          "telegram": {
          ...
          /*"otherapps": {
            ...
            "steps": [
              ...
              "Laporan Anda sudah tampil di peta. Cek RiskMap.my untuk info banjir terkini."
            ],
            "links": "<br><ul><li>Qlue:&nbsp;<a href='https://play.google.com/store/apps/details?id=org.qluein.android'><i class='icon-android'></i></a>&nbsp;&#124;&nbsp;<a href='https://itunes.apple.com/us/app/qlue-jakarta-smart-city/id987432944?ls=1&mt=8'><i class='icon-apple'></i></a></li><li><a href='http://pasangmata.detik.com/'>PasangMata</a></li><li><a href='https://www.zurich.co.id/id-id/kampanye-kami/zurich-alert-the-alert-you-really-need'>Z-Alert</a></li></ul>"
          }*/
        },
        "info_content": {
          "intro": "RiskMap.my memanfaatkan kekuatan media sosial untuk mengumpulkan, menyortir, dan menampilkan informasi banjir secara real-time.",
          "p1": "RiskMap.my merupakan sebuah proyek yang diinisiasi oleh Humanitarian Infrastructures Group di MIT yang bertujuan untuk mengembangkan CogniCity Open Source Software (CogniCity OSS) sebagai sebuah platform gratis dan terbuka untuk manajemen kebencanaan di kota-kota besar di Asia Selatan dan Tenggara.",
          ...
          "p3": "RiskMap.my mengumpulkan, menyortir, dan “memvisualisasikan” data menggunakan CogniCity Open Source Software - sebuah platform untuk manajemen kebencanaan - untuk mengubah kicauan di media sosial dan digital menjadi informasi penting bagi warga, komunitas, dan instansi pemerintah.",
          "partners": {
